...
const getCoffeeStoresUrl = (latLong, query, limit = 6) => {
    ...
    const completeQuery = `${baseAddress}${queryString}&${latLongString}&${limitString}&${radiusString}`;
...
export const fetchCoffeeStores = async (latLong = `29.6752401619802%2C-95.3329080792144`, limit = 9) => {
